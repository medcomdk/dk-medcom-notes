...
Alias: $CorePractitioner = http://medcomfhir.dk/ig/document/StructureDefinition/medcom-document-practitioner|2.0.1
Alias: $CorePractitionerRole = http://medcomfhir.dk/ig/document/StructureDefinition/medcom-document-practitionerrole|2.0.1
Alias: $DocumentPatient = http://medcomfhir.dk/ig/document/StructureDefinition/medcom-document-patient|2.0.1
Alias: $DocumentOrganization = http://medcomfhir.dk/ig/document/StructureDefinition/medcom-document-organization|2.0.1